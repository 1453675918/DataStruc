# 注册牛客网，LeetCode(必刷)
# 如果a+b+c=1000，并且a^2 + b^2 = c^2,求出所有的abc可能的组合
# 解决同一个问题，时间短的算法更好。
...
'''
    ...
    4.最终算法用什么去衡量？
        时间复杂度
    5.表示法：大O记法
        假设计算机执行算法的每个基本操作的时间是固定的一个时间单位，那么有多少个基本操作就代表会花费多少时间单位
    ...
    7.时间复杂度的几条基本计算规则
        ...
        循环结构，时间复杂度按乘法进行计算
        分支：取最大值
        判断一个算法的效率时，只需要关注操作数量的最高次项，其它次要项和常数项可以忽略
